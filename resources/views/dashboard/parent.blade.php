        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ route('dashboard.index') }}" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">{{ Config::get('app.name') }}</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            @include('dashboard.components.li', [
                'lable' => 'Subscribers',
                'routeName' => 'dashboard.subscribers',
                'icon' => 'bx bx-captions',
            ])
            ...
            @include('dashboard.components.li', [
                'lable' => 'Testimonials',
                'routeName' => 'dashboard.testimonials',
                'icon' => 'bx bx-star',
            ])
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="{{ route('dashboard.admins') }}">
                    ...
                    @livewire('dashboard.auth.admin-logout-components')
                  </ul>
                </li>
                <!--/ User -->
              </ul>
                 ...
                 <footer class="content-footer footer bg-footer-theme">
                    <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                      <div class="mb-2 mb-md-0">
                        ...
                        {{ date('Y') }}
                        , made with ❤️ by
                        <span class="footer-link fw-bolder">Subhe</span>
                      </div>
                    </div>
                  </footer>
                  <!-- / Footer -->
